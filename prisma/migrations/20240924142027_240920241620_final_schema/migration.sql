-- CreateEnum
CREATE TYPE "ProductCategories" AS ENUM ('ui_kits', 'icons');

-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('pending', 'approved', 'denied');

-- CreateEnum
CREATE TYPE "SellerStatus" AS ENUM ('notRequested', 'pending', 'approved', 'denied');
...
CREATE TABLE "User" (
    ...
    "seller" "SellerStatus" NOT NULL DEFAULT 'notRequested',
...
CREATE TABLE "Product" (
    ...
    "category" "ProductCategories" NOT NULL,
